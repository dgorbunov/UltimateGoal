...
public class CameraController extends OpenCvPipeline implements Controller {
    private OpenCvCamera openCvCamera; //Camera Object\
    private HardwareMap hardwareMap;

    public CameraController(OpenCvCamera camera, int width, int height, OpenCvCameraRotation cameraRotation, HardwareMap hardwareMap) {
        openCvCamera = camera;
